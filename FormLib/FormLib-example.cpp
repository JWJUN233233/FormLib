...
void ButtonProc(IEvent* e) {
    if (e->getEventType() == EventType::ButtonClick) {
...
void Button2Proc(IEvent* e) {
    ...
    if (e->getEventType() == EventType::ButtonDoubleClick) {
